...
Module['FS_createPath']("/", "assets", true, true);
    ...
    loadPackage({"files": [{"filename": "/assets/circle.png", "start": 0, "end": 4938}, {"filename": "/assets/cross.png", "start": 4938, "end": 9373}, {"filename": "/assets/play.wav", "start": 9373, "end": 14101}, {"filename": "/assets/rollLong.wav", "start": 14101, "end": 44637}, {"filename": "/assets/rollShort.wav", "start": 44637, "end": 66642}, {"filename": "/assets/rotate1x.png", "start": 66642, "end": 68783}, {"filename": "/assets/rotate2x.png", "start": 68783, "end": 71643}, {"filename": "/assets/rotate3x.png", "start": 71643, "end": 74684}, {"filename": "/assets/smallWin.wav", "start": 74684, "end": 87069}, {"filename": "/assets/win.wav", "start": 87069, "end": 97591}], "remote_package_size": 97591});

  })();

// end include: /tmp/tmpu34vipru.js
// include: /tmp/tmpatcct6nz.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpatcct6nz.js
// include: /tmp/tmpj6ebmccy.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpj6ebmccy.js
...
// Begin JS library code
  ...
  /** @type {function(...*):?} */
  function ___wbg_getRandomValues_1c61fac11405ffdc(
  ) {
  abort('missing function: __wbg_getRandomValues_1c61fac11405ffdc');
  }
  ___wbg_getRandomValues_1c61fac11405ffdc.stub = true;

  /** @type {function(...*):?} */
  function ___wbindgen_object_drop_ref(
  ) {
  abort('missing function: __wbindgen_object_drop_ref');
  }
  ___wbindgen_object_drop_ref.stub = true;
...
var ASM_CONSTS = {
  160904: () => { if (document.fullscreenElement) return 1; },  
 160950: () => { return document.getElementById('canvas').width; },  
 161002: () => { return parseInt(document.getElementById('canvas').style.width); },  
 161070: () => { document.exitFullscreen(); },  
 161097: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 161170: () => { if (document.fullscreenElement) return 1; },  
 161216: () => { return document.getElementById('canvas').width; },  
 161268: () => { return screen.width; },  
 161293: () => { document.exitFullscreen(); },  
 161320: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 161453: () => { return window.innerWidth; },  
 161479: () => { return window.innerHeight; },  
 161506: () => { if (document.fullscreenElement) return 1; },  
 161552: () => { return document.getElementById('canvas').width; },  
 161604: () => { return parseInt(document.getElementById('canvas').style.width); },  
 161672: () => { if (document.fullscreenElement) return 1; },  
 161718: () => { return document.getElementById('canvas').width; },  
 161770: () => { return screen.width; },  
 161795: () => { return window.innerWidth; },  
 161821: () => { return window.innerHeight; },  
 161848: () => { if (document.fullscreenElement) return 1; },  
 161894: () => { return document.getElementById('canvas').width; },  
 161946: () => { return screen.width; },  
 161971: () => { document.exitFullscreen(); },  
 161998: () => { if (document.fullscreenElement) return 1; },  
 162044: () => { return document.getElementById('canvas').width; },  
 162096: () => { return parseInt(document.getElementById('canvas').style.width); },  
 162164: () => { document.exitFullscreen(); },  
 162191: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 162249: () => { return screen.width; },  
 162274: () => { return screen.height; },  
 162300: () => { return window.screenX; },  
 162327: () => { return window.screenY; },  
 162354: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 162407: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 162478: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 162535: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 162791: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 162862: () => { if (document.fullscreenElement) return 1; },  
 162908: () => { return window.innerWidth; },  
 162934: () => { return window.innerHeight; },  
 162961: () => { if (document.pointerLockElement) return 1; },  
 163008: ($0, $1, $2, $3, $4) => { if (typeof window === 'undefined' || (window.AudioContext || window.webkitAudioContext) === undefined) { return 0; } if (typeof(window.miniaudio) === 'undefined') { window.miniaudio = { referenceCount: 0 }; window.miniaudio.device_type = {}; window.miniaudio.device_type.playback = $0; window.miniaudio.device_type.capture = $1; window.miniaudio.device_type.duplex = $2; window.miniaudio.device_state = {}; window.miniaudio.device_state.stopped = $3; window.miniaudio.device_state.started = $4; miniaudio.devices = []; miniaudio.track_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == null) { miniaudio.devices[iDevice] = device; return iDevice; } } miniaudio.devices.push(device); return miniaudio.devices.length - 1; }; miniaudio.untrack_device_by_index = function(deviceIndex) { miniaudio.devices[deviceIndex] = null; while (miniaudio.devices.length > 0) { if (miniaudio.devices[miniaudio.devices.length-1] == null) { miniaudio.devices.pop(); } else { break; } } }; miniaudio.untrack_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == device) { return miniaudio.untrack_device_by_index(iDevice); } } }; miniaudio.get_device_by_index = function(deviceIndex) { return miniaudio.devices[deviceIndex]; }; miniaudio.unlock_event_types = (function(){ return ['touchend', 'click']; })(); miniaudio.unlock = function() { for(var i = 0; i < miniaudio.devices.length; ++i) { var device = miniaudio.devices[i]; if (device != null && device.webaudio != null && device.state === window.miniaudio.device_state.started) { device.webaudio.resume().then(() => { Module._ma_device__on_notification_unlocked(device.pDevice); }, (error) => {console.error("Failed to resume audiocontext", error); }); } } miniaudio.unlock_event_types.map(function(event_type) { document.removeEventListener(event_type, miniaudio.unlock, true); }); }; miniaudio.unlock_event_types.map(function(event_type) { document.addEventListener(event_type, miniaudio.unlock, true); }); } window.miniaudio.referenceCount += 1; return 1; },  
 165166: () => { if (typeof(window.miniaudio) !== 'undefined') { window.miniaudio.referenceCount -= 1; if (window.miniaudio.referenceCount === 0) { delete window.miniaudio; } } },  
 165330: () => { return (navigator.mediaDevices !== undefined && navigator.mediaDevices.getUserMedia !== undefined); },  
 165434: () => { try { var temp = new (window.AudioContext || window.webkitAudioContext)(); var sampleRate = temp.sampleRate; temp.close(); return sampleRate; } catch(e) { return 0; } },  
 165605: ($0, $1, $2, $3, $4, $5) => { var deviceType = $0; var channels = $1; var sampleRate = $2; var bufferSize = $3; var pIntermediaryBuffer = $4; var pDevice = $5; if (typeof(window.miniaudio) === 'undefined') { return -1; } var device = {}; var audioContextOptions = {}; if (deviceType == window.miniaudio.device_type.playback && sampleRate != 0) { audioContextOptions.sampleRate = sampleRate; } device.webaudio = new (window.AudioContext || window.webkitAudioContext)(audioContextOptions); device.webaudio.suspend(); device.state = window.miniaudio.device_state.stopped; var channelCountIn = 0; var channelCountOut = channels; if (deviceType != window.miniaudio.device_type.playback) { channelCountIn = channels; } device.scriptNode = device.webaudio.createScriptProcessor(bufferSize, channelCountIn, channelCountOut); device.scriptNode.onaudioprocess = function(e) { if (device.intermediaryBufferView == null || device.intermediaryBufferView.length == 0) { device.intermediaryBufferView = new Float32Array(Module.HEAPF32.buffer, pIntermediaryBuffer, bufferSize * channels); } if (deviceType == miniaudio.device_type.capture || deviceType == miniaudio.device_type.duplex) { for (var iChannel = 0; iChannel < channels; iChannel += 1) { var inputBuffer = e.inputBuffer.getChannelData(iChannel); var intermediaryBuffer = device.intermediaryBufferView; for (var iFrame = 0; iFrame < bufferSize; iFrame += 1) { intermediaryBuffer[iFrame*channels + iChannel] = inputBuffer[iFrame]; } } _ma_device_process_pcm_frames_capture__webaudio(pDevice, bufferSize, pIntermediaryBuffer); } if (deviceType == miniaudio.device_type.playback || deviceType == miniaudio.device_type.duplex) { _ma_device_process_pcm_frames_playback__webaudio(pDevice, bufferSize, pIntermediaryBuffer); for (var iChannel = 0; iChannel < e.outputBuffer.numberOfChannels; ++iChannel) { var outputBuffer = e.outputBuffer.getChannelData(iChannel); var intermediaryBuffer = device.intermediaryBufferView; for (var iFrame = 0; iFrame < bufferSize; iFrame += 1) { outputBuffer[iFrame] = intermediaryBuffer[iFrame*channels + iChannel]; } } } else { for (var iChannel = 0; iChannel < e.outputBuffer.numberOfChannels; ++iChannel) { e.outputBuffer.getChannelData(iChannel).fill(0.0); } } }; if (deviceType == miniaudio.device_type.capture || deviceType == miniaudio.device_type.duplex) { navigator.mediaDevices.getUserMedia({audio:true, video:false}) .then(function(stream) { device.streamNode = device.webaudio.createMediaStreamSource(stream); device.streamNode.connect(device.scriptNode); device.scriptNode.connect(device.webaudio.destination); }) .catch(function(error) { console.log("Failed to get user media: " + error); }); } if (deviceType == miniaudio.device_type.playback) { device.scriptNode.connect(device.webaudio.destination); } device.pDevice = pDevice; return miniaudio.track_device(device); },  
 168433: ($0) => { return miniaudio.get_device_by_index($0).webaudio.sampleRate; },  
 168499: ($0) => { var device = miniaudio.get_device_by_index($0); if (device.scriptNode !== undefined) { device.scriptNode.onaudioprocess = function(e) {}; device.scriptNode.disconnect(); device.scriptNode = undefined; } if (device.streamNode !== undefined) { device.streamNode.disconnect(); device.streamNode = undefined; } device.webaudio.close(); device.webaudio = undefined; device.pDevice = undefined; },  
 168892: ($0) => { miniaudio.untrack_device_by_index($0); },  
 168935: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = miniaudio.device_state.started; },  
 169060: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = miniaudio.device_state.stopped; }
};
...
var wasmImports = {
  ...
  /** @export */
  __wbg_getRandomValues_1c61fac11405ffdc: ___wbg_getRandomValues_1c61fac11405ffdc,
  /** @export */
  __wbindgen_object_drop_ref: ___wbindgen_object_drop_ref,
  /** @export */
